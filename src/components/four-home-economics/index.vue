            ...
            <p class="pic-span">
              <a class="ic-box" href="javascript:;">
                <router-link to="/three/matron">
                  <img src="~im/pic(1).png">
                </router-link>
              </a>
              <a class="yuyue" href="javascript:;">
                立即预约
              </a>
            </p>
          </li>
...
<style lang="less" scoped>
  ...
  .question{
    ...
    .ban-ic{
      ...
      height: 68px;
      margin-top: 16px;
      background: url("~im/cuiru-icon.png");
    }
  }
  .WeChat{
  ...
  .hr{
    ...
    height: 34px;
    margin-bottom: 40px;
    background: url("~im/cuiru-bg.png") no-repeat center;
  }
  .content-but{
    text-align: center;
  }
 ...
 .content-box p a{
  ...
  .ul-boxContent{
    width: 240px;
    height: 208px;
    background: url("~im/cuiru-bg2.jpg");
    b{
      display: block;
      font-size: 36px;
      margin-bottom: 7px;
    ...
    i{
      position: absolute;
      background: url("~im/cuiru-bg3.png") no-repeat center;
      width: 26px;
      height: 23px;
      top: 40px;
      right: 96px;
